import{m as f,u as M,y as u}from"./chunk-USQTMXMT.js";import{Ab as t,Bb as n,Cb as s,Cc as _,Hb as d,Rb as e,Rc as P,Tb as x,Ub as h,Va as p,Ya as l,gb as g,lb as c,sb as m,xc as C}from"./chunk-X4ZQZ54I.js";function b(r,i){r&1&&(t(0,"div",23),e(1,`
      ...
      `),n())}var O=class r{constructor(){this.showAnswer=!1}ngAfterViewInit(){setTimeout(()=>{window.scrollTo(0,0),document.documentElement.style.scrollBehavior="auto",requestAnimationFrame(()=>{window.scrollTo(0,0),document.documentElement.style.scrollBehavior=""})},100)}handleKeyboardEvent(i){i.key==="ArrowDown"&&(this.scrollToNextSection(),i.preventDefault()),i.key==="ArrowUp"&&(this.scrollToPrevSection(),i.preventDefault())}scrollToNextSection(){let i=window.scrollY,o=window.innerHeight,a=Math.ceil(i/o)*o;window.scrollTo({top:a,behavior:"smooth"})}scrollToPrevSection(){let i=window.scrollY,o=window.innerHeight;if(i<o*.1){window.scrollTo({top:0,behavior:"smooth"});return}let a=Math.floor(i/o)*o;window.scrollTo({top:a,behavior:"smooth"})}static{this.\u0275fac=function(o){return new(o||r)}}static{this.\u0275cmp=g({type:r,selectors:[["app-discover"]],hostBindings:function(o,a){o&1&&d("keydown",function(w){return a.handleKeyboardEvent(w)},!1,p)},decls:151,vars:5,consts:[[1,"discover-page"],[1,"panel","hero-panel"],[1,"content"],["routerLink","/challenges"],[1,"image-container"],[1,"world-icon"],[1,"scroll-hint"],[1,"hint-text"],[1,"panel","everyday-panel"],[1,"cards-grid"],[1,"card-example"],[1,"icon"],[1,"panel","challenge-panel"],[1,"challenge-box"],["class","hint",4,"ngIf"],[1,"answer-toggle",3,"click"],["class","answer",4,"ngIf"],[1,"cta-button"],["routerLink","/tutorials",1,"button","learn-more"],[1,"panel","impact-panel"],[1,"impact-stats"],[1,"stat"],[1,"callout"],[1,"hint"],[1,"answer"]],template:function(o,a){o&1&&(t(0,"div",0),e(1,`
  `),e(2,`
  `),t(3,"section",1),e(4,`
    `),t(5,"div",2),e(6,`
      `),t(7,"h1"),e(8,"Security Is Not A Destination, "),s(9,"br"),e(10,"It's A Journey"),n(),e(11,`
      `),t(12,"p"),e(13,"Every click, every app, every connection -- security matters. "),s(14,"br"),e(15,"Start your journey today."),n(),e(16,`
